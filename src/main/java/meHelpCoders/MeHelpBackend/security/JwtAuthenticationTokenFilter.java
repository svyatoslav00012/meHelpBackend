...
public class JwtAuthenticationTokenFilter extends OncePerRequestFilter {
    ...
    public JwtAuthenticationTokenFilter(@Qualifier("userServiceImpl") UserServiceImpl userServiceImpl, JwtTokenUtil jwtTokenUtil, @Value("${jwt.header}") String tokenHeader) {
